...
@RestController
@RequestMapping(value = "/sports", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
public class SportsController {
	...
	public List<Sport> getAll() {
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Error fetching sports");
		}
	}
}
